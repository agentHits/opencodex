...
İstisna: mevcut sağlayıcı tablosunu kaldıracak bir geçiş sırasında sayfalama ilk kez algılanırsa OpenCodex bu denemeyi reddeder; mevcut konuşmaları korumak için yapılandırmayı, başvuru profilini ve günlüğü geri yükler. Aday oluşturulmadan önce algılanması veya adayın tabloyu zaten koruması, yapılandırma güncellemelerine yine izin verir.
