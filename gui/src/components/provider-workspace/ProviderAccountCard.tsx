        ...
        <div className="pwi-dense-bars-grid">
          ...
          {isAntigravity && (
            <div className="pwi-dense-col">
              ...
              {analyzed.gemini5h && gemini5hPercent !== undefined && (
              ...
              {analyzed.geminiWeekly && geminiWeeklyPercent !== undefined && (
                <div className="pwi-dense-mini-row">
                  <div className="pwi-dense-mini-label">
          ...
          {isAntigravity && (
            <div className="pwi-dense-col">
              ...
              {analyzed.claude5h && claude5hPercent !== undefined && (
                <div className="pwi-dense-mini-row">
                  <div className="pwi-dense-mini-label">
              ...
              {analyzed.claudeWeekly && claudeWeeklyPercent !== undefined && (
                <div className="pwi-dense-mini-row">
                  <div className="pwi-dense-mini-label">
