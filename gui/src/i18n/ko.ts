...
"codexSet.dialog.notRendered": "확인한 턴에서는 이 레이어가 아무것도 보내지 않았습니다. 각 섹션은 내용이 바뀔 때만 다시 전송되므로, 한 번 확인한 것만으로는 빠져 보일 수 있습니다.",
 ...
 "quota.fiveHourLimit": "5시간 한도",
  ...
  "pws.rail.collapse": "제공자 목록 접기",
  "pws.rail.expand": "제공자 목록 펼치기",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.cockpitImportComplete": "가져오기 완료: 가져옴 {imported}, 업데이트 {updated}, 실패 {failed}, 지원되지 않음 {unsupported}.",
    "pws.cockpitImportPasteClipboard": "클립보드에서 붙여넣기",
  "pws.cockpitImportPasteManual": "텍스트 붙여넣기",
  "pws.cockpitImportPastePlaceholder": "여기에 Cockpit Tools JSON 내보내기를 붙여넣으세요…",
  "pws.cockpitImportSubmit": "가져오기",
  "pws.cockpitCardTitle": "Cockpit Tools Antigravity",
  "pws.cockpitCardSubtitle": "브라우저 로그인 없이 계정 토큰 및 구독 가져오기",
  "pws.cockpitCardFootnote": "로컬 암호화: 리프레시 토큰은 이 장치의 보안 저장소에만 저장됩니다",
  "pws.cockpitImportFileShort": "파일에서",
  "pws.antigravityChoiceTitle": "Google Antigravity 연결",
  "pws.antigravityChoiceSubtitle": "계정 연결 방법을 선택하세요",
  "pws.antigravityOauthTitle": "브라우저 로그인 (Google OAuth)",
  "pws.antigravityOauthDesc": "Google 브라우저 창을 통한 표준 개인 계정 로그인",
  "pws.antigravityOauthAction": "브라우저로 로그인",
  "pws.authChoiceModalTitle": "{provider} 연결",
  "pws.authChoiceModalSubtitle": "계정 연결 방법을 선택하세요",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "pws.filterLabel": "필터",
  "pws.filterWithLimits": "한도 여유 있음",
  "pws.filterAllAccounts": "모든 계정",
  "pws.filterGeminiExhausted": "Gemini 소진됨",
  "pws.filterClaudeExhausted": "Claude 소진됨",
  "pws.filterFullyExhausted": "전체 소진됨",
  "pws.statsTotal": "총 계정",
  "pws.statsStyleLabel": "통계",
  "pws.statsStyleHybrid": "컴팩트",
  "pws.statsStyleSplit": "테이블",
  "pws.accountsUnit": "개",
  "pws.tokensTitle": "토큰",
  "pws.statsReadyCount": "{count}개 준비됨",
  "pws.statsAvailShort": "사용 가능",
  "pws.statsExhaustShort": "소진됨",
  "pws.statsPoolSummary": "풀 상태",
  "pws.statsInService": "가동 중",
  "pws.statsReauthStatus": "재인증 필요",
  "pws.reauthNeededShort": "로그인 필요",
  "pws.statsInPool": "풀 내",
  "pws.statsBothReady": "모두 사용 가능",
  "pws.statsReady": "사용 가능",
  "pws.statsClaudeOnly": "Claude만 가능",
  "pws.statsGeminiOnly": "Gemini만 가능",
  "pws.statsExhausted": "소진됨",
  "pws.statsAwaitingReset": "초기화 대기 중",
  "pws.geminiExhaustedShort": "Gemini 0%",
  "pws.claudeExhaustedShort": "Claude 0%",
  "pws.titleModeLabel": "표시 제목",
  "pws.titleEmailLogin": "이메일 로그인",
  "pws.titleAlias": "별칭",
  "pws.viewModeLabel": "보기",
  "pws.viewCards": "카드형",
  "pws.viewCompact": "컴팩트",
  "pws.sortLabel": "정렬",
  "pws.sortMoreHeadroom": "남은 한도 많은 순",
  "pws.sortLessHeadroom": "남은 한도 적은 순",
  "pws.sortActiveFirst": "활성 계정 우선",
  ...
  "pws.accountSwitchNotice": "⚡ 계정 풀: {account}(으)로 전환됨",
  "pws.providerLabelAntigravity": "Google Antigravity",
  "pws.switchToAccount": "이 계정으로 전환",
  "pws.accountSelect": "선택",
  "prov.editAliasShort": "별칭",
  "pws.geminiLimits": "Gemini 한도",
  "pws.claudeLimits": "Claude 한도",
  "pws.modelGemini": "Gemini",
  "pws.modelClaude": "Claude",
  "pws.sortGroupGeneral": "전체 한도",
  "pws.sortGroupGemini": "Gemini 한도",
  "pws.sortGroupClaude": "Claude 한도",
  "pws.sortGroupOther": "기타",
  "pws.sortGeminiMore": "Gemini: 남은 한도 많은 순",
  "pws.sortGeminiLess": "Gemini: 남은 한도 적은 순",
  "pws.sortClaudeMore": "Claude: 남은 한도 많은 순",
  "pws.sortClaudeLess": "Claude: 남은 한도 적은 순",
  "pws.sortResetSoonest": "가장 빠른 초기화 순",
  "pws.titleMaskedLogin": "마스킹 (***)",
  "pws.filterWithLimitsGemini": "Gemini 한도 있음",
  "pws.filterWithLimitsClaude": "Claude 한도 있음",
  "pws.sortReset5h": "가장 빠른 초기화 (5시간)",
  "pws.sortReset7d": "가장 빠른 초기화 (7일)",
  "pws.searchAccountsPlaceholder": "로그인, 이메일 검색...",
    "pws.window5hLabel": "5시간",
  "pws.plan.ultra": "AI Ultra",
  "pws.plan.pro": "AI Pro",
  "pws.plan.enterprise": "Enterprise",
  "pws.windowWeeklyLabel": "주간",
  "pws.gemini5hLabel": "5시간",
  "pws.geminiWeeklyLabel": "주간",
  "pws.claude5hLabel": "5시간",
  "pws.claudeWeeklyLabel": "주간",
  "pws.loginShort": "로그인",
  "pws.maskedShort": "마스킹",
  "pws.aliasShort": "별칭",
  "pws.searchAccountField": "계정 검색...",
  "pws.removeAccountConfirmTitle": "계정 삭제",
  "pws.removeAccountTooltip": "계정 삭제",
  "pws.statsClaudeAvailable": "Claude 사용 가능",
  "pws.statsGeminiAvailable": "Gemini 사용 가능",
  "pws.statsClaudeExhausted": "Claude 소진됨",
  "pws.statsGeminiExhausted": "Gemini 소진됨",
  "pws.statsFullyExhausted": "전체 소진됨",
  "pws.statsAvailable": "사용 가능",
  "pws.tokensEstimateTitle": "남은 토큰 예측",
  "pws.tokensColClaude": "Claude",
  "pws.tokensColGemini": "Gemini",
  "pws.tokensColTotal": "풀 전체",
  ...
  "pws.tokensTotal5h": "총 남음 (5h)",
  "pws.tokensTotalWeekly": "총 남음 (7d)",
  "pws.tokensGeneric5h": "남음 (5h)",
  "pws.tokensGenericWeekly": "남음 (7d)",
  "pws.tokensCalibratedFromLogs": "#logs 기준 보정",
  "pws.tokensEstimatedBaseline": "기본 예측치",
  "pws.tokensCalibratedTooltip": "요청 로그(#logs)의 실제 토큰 소비량을 기준으로 잔여 한도가 보정되었습니다",
  "genericPool.title": "계정 풀",
  "genericPool.enabledDesc": "새 세션은 남은 할당량이 {threshold}% 미만인 계정을 우선합니다. 429는 로그인한 계정 사이에서 계속 장애 조치됩니다.",
  "genericPool.enabledNoProactiveDesc": "사용량 기반 선제 전환은 임계값 0에서 꺼집니다. 429는 로그인한 계정 사이에서 계속 장애 조치됩니다.",
  "genericPool.disabledDesc": "활성 계정은 실패할 때까지 유지됩니다. 429는 로그인한 계정 사이에서 계속 장애 조치되며 끌 수 없습니다.",
  "genericPool.notice": "이 스위치는 전송 전 선제 선택만 제어합니다. 라운드로빈과 fill-first는 여기에 저장되며 공유 풀 커널이 켜져 있을 때 적용됩니다.",
  "genericPool.needTwoAccounts": "선제 선택을 켜기 전에 OAuth 계정을 두 개 이상 추가하세요.",
  "genericPool.threshold": "선제 사용량 임계값",
  "genericPool.thresholdAria": "선제 사용량 임계값, 퍼센트",
  "genericPool.thresholdHelp": "0은 선제 선택을 끄고 429 전까지 활성 계정을 유지합니다. 기본값 80. 할당량 증거가 있을 때 적용됩니다.",
  "genericPool.loadFailed": "풀 설정을 불러오지 못했습니다.",
  "genericPool.saveFailed": "풀 설정을 저장하지 못했습니다.",
  "genericPool.visualTitle": "풀이 계정을 고르는 방식",
  "genericPool.visualLive": "이 요청",
  "genericPool.visualStored": "저장됨, 아직 적용 안 됨",
  "genericPool.visualAccountA": "활성 계정",
  "genericPool.visualAccountB": "다음 계정",
  "genericPool.visualUsage": "활성 계정 사용량 예시",
  ...
  "genericPool.visualKernelGap": "라운드로빈과 필 퍼스트는 공유 풀 커널이 켜질 때까지 저장만 됩니다. 그때까지 실제 경로는 할당량입니다.",
  "genericPool.visual429": "429는 로그인한 계정 사이에서 항상 장애 조치됩니다.",
  "genericPool.visualSwitchAt": "{pct}%에서 이동",
