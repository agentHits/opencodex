...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "dash.codexClientCompactionHint": "既定ではオフです。新しい OpenCodeX ocx1 状態ではなく、移植可能な平文要約を保存します。V2 サブエージェントのルーティングは変わりません。既存の ocx1 履歴は別途復旧が必要です。変更後は Codex を再起動してください。",
