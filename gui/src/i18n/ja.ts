...
"common.discard": "破棄",
 ...
 "quota.fiveHourLimit": "5 時間上限",
  ...
  "pws.rail.collapse": "プロバイダーリストを折りたたむ",
  "pws.rail.expand": "プロバイダーリストを展開する",
  ...
  "pws.cockpitImportComplete": "インポート完了: インポート {imported}、更新 {updated}、失敗 {failed}、未対応 {unsupported}。",
    "pws.cockpitImportPasteClipboard": "クリップボードから貼り付け",
  "pws.cockpitImportPasteManual": "テキストを貼り付け",
  "pws.cockpitImportPastePlaceholder": "ここに Cockpit Tools JSON エクスポートを貼り付け…",
  "pws.cockpitImportSubmit": "インポート",
  "pws.cockpitCardTitle": "Cockpit Tools Antigravity",
  "pws.cockpitCardSubtitle": "ブラウザログインなしでアカウントトークンとサブスクリプションをインポート",
  "pws.cockpitCardFootnote": "ローカル暗号化: リフレッシュトークンはこのデバイスの安全なストレージにのみ保存されます",
  "pws.cockpitImportFileShort": "ファイルから",
  "pws.antigravityChoiceTitle": "Google Antigravity を接続",
  "pws.antigravityChoiceSubtitle": "アカウントの接続方法を選択してください",
  "pws.antigravityOauthTitle": "ブラウザログイン (Google OAuth)",
  "pws.antigravityOauthDesc": "Google のブラウザウィンドウを介した標準的な個人アカウントログイン",
  "pws.antigravityOauthAction": "ブラウザでログイン",
  "pws.authChoiceModalTitle": "{provider} を接続",
  "pws.authChoiceModalSubtitle": "アカウントの接続方法を選択してください",
...
"codexSet.dialog.notRendered": "確認したターンでは、このレイヤーは何も送信していません。各セクションは内容が変わったときだけ再送されるため、一度の確認では欠けて見えることがあります。",
  ...
  "pws.filterLabel": "フィルター",
  "pws.filterWithLimits": "制限あり（いずれか）",
  "pws.filterAllAccounts": "すべてのアカウント",
  "pws.filterGeminiExhausted": "Gemini制限到達",
  "pws.filterClaudeExhausted": "Claude制限到達",
  "pws.filterFullyExhausted": "すべて制限到達",
  "pws.statsTotal": "合計",
  "pws.statsStyleLabel": "統計",
  "pws.statsStyleHybrid": "コンパクト",
  "pws.statsStyleSplit": "テーブル",
  "pws.accountsUnit": "件",
  "pws.tokensTitle": "トークン",
  "pws.statsReadyCount": "{count}件 準備完了",
  "pws.statsAvailShort": "利用可能",
  "pws.statsExhaustShort": "消費済",
  "pws.statsPoolSummary": "プール状態",
  "pws.statsInService": "稼働中",
  "pws.statsReauthStatus": "再認証が必要",
  "pws.reauthNeededShort": "要ログイン",
  "pws.statsInPool": "プール内",
  "pws.statsBothReady": "両方利用可能",
  "pws.statsReady": "利用可能",
  "pws.statsClaudeOnly": "Claudeのみ",
  "pws.statsGeminiOnly": "Geminiのみ",
  "pws.statsExhausted": "制限到達",
  "pws.statsAwaitingReset": "リセット待ち",
  "pws.geminiExhaustedShort": "Gemini 0%",
  "pws.claudeExhaustedShort": "Claude 0%",
  "pws.titleModeLabel": "表示名",
  "pws.titleEmailLogin": "メールログイン",
  "pws.titleAlias": "エイリアス",
  "pws.viewModeLabel": "表示形式",
  "pws.viewCards": "カード",
  "pws.viewCompact": "コンパクト",
  "pws.sortLabel": "並び替え",
  "pws.sortMoreHeadroom": "空き枠が多い順",
  "pws.sortLessHeadroom": "空き枠が少ない順",
  "pws.sortActiveFirst": "有効を優先",
  ...
  "pws.accountSwitchNotice": "⚡ アカウントプール: {account} に切り替えました",
  ...
  "pws.geminiLimits": "Gemini制限",
  "pws.claudeLimits": "Claude制限",
  "pws.modelGemini": "Gemini",
  "pws.modelClaude": "Claude",
  "pws.sortGroupGeneral": "全体枠",
  "pws.sortGroupGemini": "Gemini制限",
  "pws.sortGroupClaude": "Claude制限",
  "pws.sortGroupOther": "その他",
  "pws.sortGeminiMore": "Gemini: 空き枠が多い順",
  "pws.sortGeminiLess": "Gemini: 空き枠が少ない順",
  "pws.sortClaudeMore": "Claude: 空き枠が多い順",
  "pws.sortClaudeLess": "Claude: 空き枠が少ない順",
  "pws.sortResetSoonest": "リセットが最も近い順",
  "pws.titleMaskedLogin": "マスク (***)",
  "pws.filterWithLimitsGemini": "Gemini枠あり",
  "pws.filterWithLimitsClaude": "Claude枠あり",
  "pws.sortReset5h": "最短リセット（5時間枠）",
  "pws.sortReset7d": "最短リセット（7日間枠）",
  "pws.searchAccountsPlaceholder": "ログイン名、メールで検索...",
    "pws.window5hLabel": "5時間",
  "pws.plan.ultra": "AI Ultra",
  "pws.plan.pro": "AI Pro",
  "pws.plan.enterprise": "Enterprise",
  "pws.windowWeeklyLabel": "週間",
  "pws.gemini5hLabel": "5時間",
  "pws.geminiWeeklyLabel": "週間",
  "pws.claude5hLabel": "5時間",
  "pws.claudeWeeklyLabel": "週間",
  "pws.loginShort": "ログイン",
  "pws.maskedShort": "マスク",
  "pws.aliasShort": "別名",
  "pws.searchAccountField": "アカウント検索...",
  "pws.removeAccountConfirmTitle": "アカウントの削除",
  "pws.removeAccountTooltip": "アカウントを削除",
  "pws.statsClaudeAvailable": "Claude利用可能",
  "pws.statsGeminiAvailable": "Gemini利用可能",
  "pws.statsClaudeExhausted": "Claude制限到達",
  "pws.statsGeminiExhausted": "Gemini制限到達",
  "pws.statsFullyExhausted": "すべて制限到達",
  "pws.statsAvailable": "利用可能",
  "pws.tokensEstimateTitle": "残りトークン見積もり",
  "pws.tokensColClaude": "Claude",
  "pws.tokensColGemini": "Gemini",
  "pws.tokensColTotal": "プール合計",
  ...
  "pws.tokensTotal5h": "合計 (5h)",
  "pws.tokensTotalWeekly": "合計 (7d)",
  "pws.tokensGeneric5h": "残り (5h)",
  "pws.tokensGenericWeekly": "残り (7d)",
  "pws.tokensCalibratedFromLogs": "#logs から測定",
  ...
  "genericPool.enabledNoProactiveDesc": "しきい値 0 では使用量に基づく先行切り替えはオフです。429 ではログイン済みアカウント間で引き続きフェイルオーバーします。",
  "genericPool.disabledDesc": "失敗するまでアクティブアカウントを維持します。429 ではログイン済みアカウント間で引き続きフェイルオーバーし、オフにはできません。",
  "genericPool.notice": "このスイッチは送信前の先行選択だけを制御します。ラウンドロビンと fill-first はここに保存され、共有プールカーネルがオンのときに適用されます。",
  "genericPool.needTwoAccounts": "先行選択を有効にする前に、OAuth アカウントを少なくとも 2 つ追加してください。",
  "genericPool.threshold": "先行使用量のしきい値",
  "genericPool.thresholdAria": "先行使用量のしきい値（パーセント）",
  "genericPool.thresholdHelp": "0 は先行選択を無効にし、429 までアクティブアカウントを維持します。既定値は 80。クォータ証拠があるときに適用されます。",
  "genericPool.loadFailed": "プール設定を読み込めませんでした。",
  "genericPool.saveFailed": "プール設定を保存できませんでした。",
  "genericPool.visualTitle": "プールの選び方",
  "genericPool.visualLive": "このリクエスト",
  "genericPool.visualStored": "保存済み・未適用",
  "genericPool.visualAccountA": "アクティブなアカウント",
  "genericPool.visualAccountB": "次のアカウント",
  "genericPool.visualUsage": "アクティブアカウントの使用量の例",
  ...
  "genericPool.visualKernelGap": "ラウンドロビンとフィルファーストは共有プールカーネルがオンになるまで保存のみです。それまではクォータが実際の経路です。",
  "genericPool.visual429": "429 ではログイン済みアカウント間で必ずフェイルオーバーします。",
  "genericPool.visualSwitchAt": "{pct}% で移動",
