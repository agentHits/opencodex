...
"codexSet.dialog.notRendered": "На прочитанном нами шаге этот слой ничего не отправил. Разделы пересылаются только при изменении, поэтому в одной выборке слой может отсутствовать.",
  ...
  "dash.codexClientCompactionHint": "По умолчанию выключено. Сохраняет переносимые текстовые сводки вместо нового состояния OpenCodeX ocx1. Маршрутизация подагентов V2 не меняется. Существующую историю ocx1 всё равно нужно восстановить. После изменения перезапустите Codex.",
